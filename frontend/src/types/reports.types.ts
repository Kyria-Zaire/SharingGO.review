...
export type ReportsPeriodPreset = "today" | "7d" | "30d" | "custom";

export interface ReportsPeriodState extends ReportsPeriod {
  preset: ReportsPeriodPreset;
}

export interface ReportsTripsFilters {
  lifecycleStatus?: TripLifecycleStatus;
  limit: number;
  offset: number;
}

export interface ReportsIncidentsFilters {
  status?: IncidentStatus;
  type?: IncidentType;
  severity?: IncidentSeverity;
  limit: number;
