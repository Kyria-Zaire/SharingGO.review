...
import { HELP_ERROR } from "@/features/help/constants/help-content";

export function HelpErrorCard({ onRetry }: { onRetry: () => void }) {
  return (
    <div
    ...
    >
      ...
      <h2 className="mt-4 text-lg font-semibold text-foreground">{HELP_ERROR.title}</h2>
